  ...
  return (
    <div className="mx-auto max-w-3xl rounded-2xl border bg-white p-6">
      ...
      <p className="mt-2 text-sm text-slate-600">
        Share your query and our support team will get back within business hours.
      </p>
      ...
      <form onSubmit={onSubmit} className="mt-5 space-y-4">
        ...
        <Input label="Subject" value={form.subject} onChange={(v) => onChange("subject", v)} required />
        <TextArea
          label="Message"
          value={form.message}
